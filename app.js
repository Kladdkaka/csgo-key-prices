...
function GetAssetPrices(callback) {
    $.getJSON('http://cors-anywhere.herokuapp.com/https://api.steampowered.com/ISteamEconomy/GetAssetPrices/v1/?key=' + api_key + '&format=json&appid=730', function (rawPrices) {
